...
@celery_app.task(name="nexobank.cleanup_expired_refresh_tokens")  # type: ignore[untyped-decorator]
...
@celery_app.task(name="nexobank.generate_monthly_statement")  # type: ignore[untyped-decorator]
